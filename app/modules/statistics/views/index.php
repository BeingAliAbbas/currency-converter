          ...
          <div class="d-flex align-items-center">
            <span class="stamp stamp-md bg-success-gradient text-white mr-3">
              ...
              <div class="d-flex order-lg-2 ml-auto">
                <div class="ml-2 d-lg-block text-right">
                  <?php if ($currency == 1) {
                    $total_balance = $data_log->user_balance/76;
                  } else {
                    $total_balance = $data_log->user_balance;
                  }
                  ?>
                  <h4 class="m-0 text-right number"><?php echo $sign_convert; ?><?= (!empty($total_balance)) ? currency_format($total_balance, get_option('currency_decimal', 2), $decimalpoint, $separator) : 0 ?></h4>
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="d-flex order-lg-2 ml-auto">
              <div class="ml-2 d-lg-block text-right">
                <?php
                if ($currency == 1) {
                  $total_s_r = $data_log->total_spent_receive/76;
                } else {
                  $total_s_r = $data_log->total_spent_receive;
                }
                ?>
                <h4 class="m-0 text-right number"><?php echo $sign_convert; ?><?= (!empty($total_s_r)) ? currency_format($total_s_r, get_option('currency_decimal', 2), $decimalpoint, $separator) : 0 ?></h4>
